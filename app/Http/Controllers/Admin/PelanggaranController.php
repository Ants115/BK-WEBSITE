...
class PelanggaranController extends Controller
{
    ...
    {
        // Pastikan model Pelanggaran memiliki relasi 'pelanggaranSiswa' 
        // Jika belum ada relasi di Model, baris withCount ini akan error.
        // Jika belum ada relasi, hapus "withCount(...)" dan cek manual atau biarkan database handle constraint.
