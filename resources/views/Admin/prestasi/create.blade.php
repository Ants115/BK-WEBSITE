                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.prestasi.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="judul" value="{{ old('judul') }}" class="w-full rounded-md border-gray-300 shadow-sm text-sm" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                                ...
                                <select name="tingkat" class="w-full rounded-md border-gray-300 shadow-sm text-sm" required>
                                    ...
                                    @foreach($tingkatOptions as $opt)
                                        <option value="{{ $opt }}" @selected(old('tingkat') == $opt)>{{ $opt }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal" value="{{ old('tanggal') }}" class="w-full rounded-md border-gray-300 shadow-sm text-sm" required>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="keterangan" rows="4" class="w-full rounded-md border-gray-300 shadow-sm text-sm">{{ old('keterangan') }}</textarea>
