                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.pelanggaran.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_pelanggaran" id="nama_pelanggaran" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                        </div>
    ...
    <button type="submit" ...>
        Simpan
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="poin" id="poin" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                        </div>
                        <div class="flex items-center justify-end">
                            <a href="{{ route('admin.pelanggaran.index') }}" class="text-gray-600 mr-4">Batal</a>
