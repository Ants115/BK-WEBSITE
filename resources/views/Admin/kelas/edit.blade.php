                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.kelas.update', $kelas) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_kelas" value="{{ old('nama_kelas', $kelas->nama_kelas) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                            ...
                            <div>
                                ...
                                <select name="tingkatan_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                    ...
                                    @foreach($tingkatans as $t)
                                        <option value="{{ $t->id }}" @selected(old('tingkatan_id', $kelas->tingkatan_id) == $t->id)>
                                            {{ $t->nama_tingkatan }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                Hanya user dengan role guru_bk / wali_kelas yang muncul di daftar ini.
                            </p>
