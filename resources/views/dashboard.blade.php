                ...
                <div class="mb-6 bg-blue-50 border-l-4 border-blue-500 p-4 shadow-sm rounded-r-lg">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('konsultasi.riwayat') }}" class="text-sm font-medium text-blue-600 hover:text-blue-500 underline">Lihat Detail &rarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="p-4 border rounded-lg bg-gray-50">
                            ...
                            <p class="text-2xl font-bold">{{ $totalPengajuan }} <span class="text-sm font-normal">kali</span></p>
                        </div>
                    ...
                    <div class="mt-6">
                        <a href="{{ route('konsultasi.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
